        ...
        <div class="mx-auto w-full sm:px-4 lg:px-6">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-8 text-gray-900">
                    <form action="{{ route('admin.correspondentes.store') }}" class="mt-3" method="post">
                        @csrf
                        <div class="flex flex-col">
                            <label for="nome_correspondente" class="text-black">Nome Correspondente</label>
                            <input type="text" name="nome_correspondente" id="nome_correspondente" value="{{ old('nome_correspondente') }}"
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="text" name="nome_responsavel" id="nome_responsavel" value="{{ old('nome_responsavel') }}"
                                class="mt-2 rounded-lg border-gray-300 py-1 focus:border-gray-300 focus:outline-none focus:ring-0">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="text" name="phone_contato" id="phone_contato" value="{{ old('phone_contato') }}"
                                class="mt-2 rounded-lg border-gray-300 py-1 focus:border-gray-300 focus:outline-none focus:ring-0">
                            @error('phone_contato')
                                <span class="text-nowrap mb-3 mt-3 rounded-full px-2 py-2 text-sm text-red-500">*{{ $message }}. Tecle [F5]</span>
                            @enderror
