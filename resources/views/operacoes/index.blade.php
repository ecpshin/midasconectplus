            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-4 text-gray-900">
                    ...
                    <div class="rounded-lg bg-white px-8 py-6">
                        <a href="{{ route('admin.operacoes.create') }}"
                                ...
                                @foreach ($operacoes as $operacao)
                                    <tr class="bg-gray-200 transition duration-200 even:bg-slate-50 hover:bg-red-400 hover:bg-opacity-20">
                                        ...
                                        <td class="flex items-center space-x-1 py-1 pl-2">
                                            <a href="{{ route('admin.operacoes.show', $operacao) }}"
                                            ...
                                            <a href="{{ route('admin.operacoes.edit', $operacao) }}"
                                            ...
                                            <form action="{{ route('admin.operacoes.destroy', $operacao->id) }}" method="post" id="form_{{ $operacao->id }}">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </td>
