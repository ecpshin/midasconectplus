<x-midas-layout>
    <x-slot name="header">
        <x-bread area="{{ $area }}" page="{{ $page }}" rota="admin.operacoes.index"></x-bread>
    </x-slot>
            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="gap-3 px-8 py-6 text-gray-900">
                    <fieldset class="mb-5 flex flex-col" disabled>
                        <label for="descricao_operacao" class="font-semibold text-black">Descrição da Operação</label>
                        <input class="mt-2 rounded-lg border-gray-300 py-1" placeholder="{{ $operacao->descricao_operacao }}">
                    </fieldset>
