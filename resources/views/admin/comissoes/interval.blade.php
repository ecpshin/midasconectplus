        ...
        <div class="mx-auto w-full sm:px-4 lg:px-6">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-4 text-gray-900">
                    ...
                    <form action="{{ route('admin.propostas.por-intervalo') }}" method="POST">
                        @csrf
                            ...
                            @forelse ($propostas as $proposta)
                                <tr class="odd:bg-fuchsia-100">
                                    <td class="text-sm font-semibold">
                                        {{ $proposta->id }}</td>
                                    <td class="text-sm font-semibold capitalize">
                                    ...
                                    <td class="overflow-hidden text-clip text-sm font-semibold capitalize">{{ $proposta->user->name }}</td>
