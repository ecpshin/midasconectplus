            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-4 text-gray-900">
                    ...
                    <div class="custom-scrollbar mb-12 overflow-x-scroll rounded-lg bg-white px-8 py-6">
                        <a href="{{ route('admin.financeiras.create') }}"
                            class="rounded-md bg-emerald-900 px-3 py-2 text-sm text-white shadow-md shadow-emerald-950 hover:bg-emerald-600">Adicionar</a>
                                ...
                                @foreach ($financeiras as $financeira)
                                    <tr class="bg-gray-200 transition duration-200 even:bg-slate-50 hover:bg-red-400 hover:bg-opacity-20">
                                        ...
                                        <td class="flex items-center space-x-1 py-3 pl-2">
                                            <a href="{{ route('admin.financeiras.show', $financeira) }}"
                                            ...
                                            <a href="{{ route('admin.financeiras.edit', $financeira) }}"
