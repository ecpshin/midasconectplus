        ...
        <div class="mx-auto w-full sm:px-4 lg:px-6">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-8 text-gray-900">
                    <form action="{{ route('admin.produtos.store') }}" class="mt-3" method="post">
                        @csrf
                        <div class="flex flex-col">
                            <label for="descricao_produto" class="text-black">Descrição do Produto</label>
                            <input type="text" name="descricao_produto" id="descricao_produto" value="{{ old('descricao_produto') }}"
